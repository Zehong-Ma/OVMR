...
from .ins_detic_fast_rcnn import InsDeticFastRCNNOutputLayers
...
class InsDeticCascadeROIHeads(CascadeROIHeads):
    @configurable
    def __init__(
        self,
        *,
        ...
        **kwargs,
        ...
        self.cls_score = InsZeroShotClassifier(cfg, input_shape)
