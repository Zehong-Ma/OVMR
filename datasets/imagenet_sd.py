...
class ImageNetSD(DatasetBase):

    dataset_dir = "imagenet_sd"
    ...
    def __init__(self, cfg):
        ...
        # print([(item.impath, "train") for item in preprocessed['train']])
        # print([(item.impath, "test") for item in preprocessed['test']])
    ...
    def read_data(self, classnames, split_dir):
        if split_dir=="train":
            ...
            image_dir = deepcopy(self.image_dir).replace("imagenet_sd", "imagenet")
